      ...
      illustration: (
        <div className="onboarding-illustration-box">
          <svg width="220" height="220" viewBox="0 0 220 220" fill="none" xmlns="http://www.w3.org/2000/svg">
            {/* AR Scan Brackets */}
            <path d="M 40 70 L 40 40 L 70 40" stroke="#FF4D8D" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M 180 70 L 180 40 L 150 40" stroke="#FF4D8D" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M 40 150 L 40 180 L 70 180" stroke="#FF4D8D" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M 180 150 L 180 180 L 150 180" stroke="#FF4D8D" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
            ...
            <g transform="translate(68, 95)">
              <rect x="0" y="0" width="36" height="26" rx="8" stroke="#FF4D8D" strokeWidth="3.5" fill="rgba(255, 77, 141, 0.15)" />
        ...
        <div className="onboarding-illustration-box">
          ...
          <div
            ...
            style={{
              ...
              height: '145px',
              borderRadius: '20px',
              background: 'linear-gradient(135deg, rgba(124, 77, 255, 0.4) 0%, rgba(27, 31, 74, 0.8) 100%)',
              display: 'flex',
              flexDirection: 'column',
              justifyContent: 'space-between',
              padding: '18px',
              boxShadow: '0 12px 36px rgba(124, 77, 255, 0.3)',
          ...
          >
            ...
            <div style={{ textAlign: 'left' }}>
              <div style={{ fontSize: '24px', fontWeight: '800', color: '#FF4D8D', textShadow: '0 0 12px rgba(255,77,141,0.5)' }}>FLAT 25% OFF</div>
